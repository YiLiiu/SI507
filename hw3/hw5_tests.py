...
class TestCard(unittest.TestCase):
    ...
    def test_q5(self):
        ...
        deck = hw5_cards.Deck()
        deal = deck.deal_card()
        self.assertIsInstance(deal, hw5_cards.Card)
        return deal, hw5_cards.Card
    ...
    def test_q6(self):
        ...
        '''
        deck = hw5_cards.Deck()
        pre_len = len(deck.cards)
        deck.deal_card()
        cur_len = len(deck.cards)
        self.assertEqual(cur_len, pre_len - 1)
        return cur_len, pre_len - 1 
    ...
    def test_q7(self):
        ...
        deck = hw5_cards.Deck()
        pre_len = len(deck.cards)
        card_moved = deck.deal_card()
        deck.replace_card(card_moved)
        cur_len = len(deck.cards)
        self.assertEqual(pre_len, cur_len, 52)
        return pre_len, cur_len, 52
    ...
    def test_q8(self):
        ...
        deck = hw5_cards.Deck()
        pre_len = len(deck.cards)
        deck.replace_card(deck.cards[1])
        cur_len = len(deck.cards)
        self.assertEqual(pre_len, cur_len)
        return pre_len, cur_len
